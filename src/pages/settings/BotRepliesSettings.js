...
export default function BotRepliesSettings() {
  ...
  const fetchReplies = async () => {
    try {
      const res = await axios.get("https://chat-back-ymlq.onrender.com/api/auth/get-replies");
  ...
  const handleAdd = async () => {
    ...
    setLoading(true);
    try {
      await axios.post("https://chat-back-ymlq.onrender.com/api/auth/add-reply", {
        content: replyInput,
      });
...
const handleDelete = async (id) => {
  try {
    await axios.delete(`https://chat-back-ymlq.onrender.com/api/auth/delete-reply/${id}`);
  ...
  const handleEdit = async (id) => {
    try {
      await axios.put(`https://chat-back-ymlq.onrender.com/api/auth/update-reply/${id}`, {
        content: editContent,
      });
      setEditId(null);
      fetchReplies();
